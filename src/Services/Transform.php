    ...
    public static function notif(array $notif): string
    {
        ...
        return match (Notifications::from($notif['category'])) {
            ...
            Notifications::TodoDeadline =>
                sprintf(
                    '<span data-action="ack-notif" data-id="%d" data-href="dashboard.php?open=todolist&amp;task=%d">%s</span>' . $relativeMoment,
                    (int) $notif['id'],
            ...
            Notifications::OrderStatusChanged =>
                sprintf(
                    ...
                    sprintf(
                        ...
                        $notif['body']['changer_fullname'],
                        htmlspecialchars($notif['body']['title'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'),
                        htmlspecialchars($notif['body']['status_label'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'),
                    ),
                    $notif['created_at'],
                ),
