...
function SpreadsheetEditor() {
  ...
  return (
    <>
      ...
      <SpreadsheetInner key={spreadsheetKey} data={data} buildToolbar={buildToolbar} onPasteStyles={onPasteStyles} spreadsheetRef={spreadsheetRef} />
    </>
  );
}

function SpreadsheetInner({ data, buildToolbar, onPasteStyles, spreadsheetRef }) {
  return (
    <Spreadsheet ref={spreadsheetRef} tabs={true} toolbar={buildToolbar} onpaste={onPasteStyles}>
